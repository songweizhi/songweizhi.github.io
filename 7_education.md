...
<div id="banner">
    ...
    <div class="inline-block" style="display:inline-block;">
  		<img style="float:right; display: block;" src="/assets/images/UNSW.png" style="width: 150px;">
    </div>
...
<div id="banner">
	...
	<div class="inline-block" style="display:inline-block;">
		...
		<p><i class="fa fa-university" aria-hidden="true" style="font-size:18px"></i> The First Institute of Oceanography, Ministry of <br> Natural Resources, Shandong, China </p>
	</div>
...
<div id="banner">
	...
	<div class="inline-block" style="display:inline-block;" margin-left="-.25rem;">
		<p><i class="fa fa-clock" aria-hidden="true" style="font-size:18px"></i> 2005 - 2009 </p>
		<p><i class="fa fa-graduation-cap" aria-hidden="true" style="font-size:18px"></i> Bachelor of Engineering </p>
		<p><i class="fa fa-book" aria-hidden="true" style="font-size:18px"></i> Biological Engineering </p>
		<p><i class="fa fa-university" aria-hidden="true" style="font-size:18px"></i> Shandong Jianzhu University, Shandong, China </p>
	</div>
